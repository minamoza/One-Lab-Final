...
//        let searchPage = DiscoverCollectionView()
        let searchPage = HeaderCollectionView()
//        let searchPage = DiscoveryCollectionView(viewModel: PhotoViewModel(photoService: GetPhotoServiceImpl()))
//        let myPins = MyPinsVC()
